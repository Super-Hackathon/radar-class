...
ax.set_rticks([10,30,50,70,100]) # show 10 different distances
ax.set_thetagrids([0,10,30,50,70,90,110,130,150,170,180]) # show 10 angles
...
latest_text = ax.text(0.03, 0.97, "BACKGROUND",
...
#               Update Legend text (not working with scan)
#               latest_text.set_text(f"Latest return\nAngle: {angle:3.0f}°\nDist: {dist:.1f} cm")
#               latest_text.set_color('lime')
#               ax.draw_artist(latest_text)
